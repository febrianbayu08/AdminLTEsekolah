...
<head>
  ...
  <title>Tambah Jurusan | Admin</title>
                  ...
                  <form action="tambahjurusan.php" method="post">
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="mb-3">
                          <label for="namajurusan" class="mb-2">Nama Jurusan</label>
                          <input type="text" class="form-control" id="namajurusan" name="namajurusan" placeholder="Masukkan Nama Jurusan" required>
                        </div>
                      </div>
                    </div>
