...
$kodeagama = $_GET['id'];
$agama_data = $db->get_agama_by_id($kodeagama);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($db->update_agama($kodeagama, $kodeAgama, $agama)) {
    // Redirect to department data page after successful update
    header("Location: ../data/dataagama.php");
    exit();
  } else {
    $error_message = "Gagal memperbarui data agama!";
  }
}
?>
...
<head>
  ...
  <meta name="title" content="Edit Agama" />
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-end">
                ...
                <li class="breadcrumb-item"><a href="../data/dataagama.php">Data Agama</a></li>
            ...
            <div class="col-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="editagama.php?id=<?= htmlspecialchars($kodeagama); ?>" method="post">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="mb-3">
                          <label for="kodeagama" class="form-label">Kode Agama</label>
                          <input type="text" class="form-control" id="kodeagama" name="kodeagama" value="<?= htmlspecialchars($agama_data['kodeagama']); ?>" placeholder="Masukkan Kode Agama" required>
                        </div>
                        <div class="mb-3">
                          <label for="agama" class="mb-2">Agama</label>
                          <input type="text" class="form-control" id="agama" name="agama" value="<?= htmlspecialchars($agama_data['agama']); ?>" placeholder="Masukkan Agama" required>
                        </div>
                      </div>
                    </div>
