...
if (isset($_GET['action']) && $_GET['action'] == 'delete' && isset($_GET['id'])) {
  $id = $_GET['id'];
  if ($db->hapus_agama($id)) {
    $success_message = "Data agama berhasil dihapus!";
  } else {
    $error_message = "Gagal menghapus data agama!";
  }
}

// Get all religion data
$agama = $db->tampil_agama();
?>
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <a href="../addData/tambahagama.php" class="btn btn-primary btn-sm">
                      <i class="bi bi-plus"></i> Tambah Agama
                    </a>
                  </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  ...
                  <table id="agamaTable" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th>Kode Agama</th>
                        <th>Agama</th>
                    ...
                    <tbody>
                      ...
                      foreach ($agama as $row): ?>
                        <tr>
                          <td><?= htmlspecialchars($row['kodeagama']); ?></td>
                          <td><?= htmlspecialchars($row['agama']); ?></td>
                          <td>
                            <a href="../edit/editagama.php?id=<?= $row['kodeagama']; ?>" class="btn btn-warning btn-sm">
                              <i class="bi bi-pencil"></i>
                            </a>
                            <a href="javascript:void(0);" onclick="confirmDelete('<?= $row['kodeagama']; ?>')"
  ...
  <script>
    ...
    function confirmDelete(id) {
      if (confirm('Apakah Anda yakin ingin menghapus data ini?')) {
        window.location.href = 'dataagama.php?action=delete&id=' + id;
      }
    }
  </script>
